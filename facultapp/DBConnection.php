...
class DBConnection {
    ...
    private function __construct() {
        try {
            $this->_PDOInstance = new PDO('mysql:host=localhost;dbname=facultapp;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
